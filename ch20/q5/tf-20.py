...
def load_plugins():
    ...
    tfwords = importlib.machinery.SourceFileLoader("tfwords", words_plugin).load_module()
    tffreqs = importlib.machinery.SourceFileLoader("tffreqs", frequencies_plugin).load_module()
