...
# $ python3 q2.py ../pride-and-prejudice.txt 
# Traceback (most recent call last):
#   File "q2.py", line 79, in <module>
#     WordFrequencyController(sys.argv[1]).run()
#   File "q2.py", line 75, in run
#     word_freqs = self._word_freq_counter.sorted()
# AttributeError: 'WordFrequencyManager' object has no attribute 'sorted'