import sys, string, os, re, operator, collections
...
if len(sys.argv) > 1:
    ...
    frequencies_func = "lambda word_list : collections.Counter(word_list)"
...
exec("stops = set(open('../stop_words.txt').read().split(',') + list(string.ascii_lowercase))")
