...
data.extend(None for _ in range(8, 1024)) # data[8] ~ data[1023]
...
while True:
    ...
    while data[1] < 1024:
        if data[data[1]] == '':
            break
        if data[data[1]][len(data[data[1]])-1] != '\n':
        ...
        for c in data[data[1]]:
            if data[2] == None:
                ...
                if not c.isalnum():
                    data[4] = False 
                    data[5] = data[data[1]][data[2]:data[3]].lower()
