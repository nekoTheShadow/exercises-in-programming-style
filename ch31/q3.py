import sys, re, operator, string, functools, concurrent.futures
...
def concurrent_map(func, lst):
    with concurrent.futures.ThreadPoolExecutor() as tpe:
        return tpe.map(func, lst)

splits = concurrent_map(split_words, partition(read_file(sys.argv[1]), 200))
